...
public class server extends javax.swing.JFrame {
    ...
    private void onclose(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_onclose
        ...
        outVoice = false;
        String Name = allDominos.get(0).replace("C:\\SPIC-Server\\data\\", "");
...
//        Toolkit.getDefaultToolkit().beep();                     // beep sound before text presentation
        log.info("Server word Presented = " + target.getText());
        log.info("Server Presented = " + System.currentTimeMillis());

//        if(sp.equals("--END--,--END--")){
//            
//        }
//        U.TriggerParallel(1);
    }
    ...
    public void sendmsg() {
        ...
        try {
            ...
            while (cc[0].getStatus() == Call.Status.INPROGRESS) {
                ...
                log.info("Server word sent= " + message);
...
//                U.TriggerParallel(2);
    ...
    public class SampleChatMessageListener implements ChatMessageListener {
        ...
        public void chatMessageReceived(final ChatMessage message) {
            try {
                log.info("Server word recieved = XXX");
